<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ListOfJoins.aspx.vb" Inherits="ListOfJoins" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>List Of DB Joins</title>
    <style type="text/css">
        .auto-style1 {
            width: 107px;
            height: 26px;
...
<body>
    ...
    <asp:UpdatePanel ID="udpJoinsList" runat ="server" >
       <ContentTemplate>
            <div>
           <table>
      <tr>
...
<asp:TreeView ID="TreeView1"  runat="server" Width="100%" NodeIndent="10" Font-Names="Times New Roman"  EnableTheming="True" ImageSet="BulletedList">
          <Nodes>  
            ...
            <asp:TreeNode Text="&lt;b&gt;Documentation&lt;/b&gt;"  Value="DataAIHelp.aspx" Expanded="True" >
   ...
   <td id="main" style="width: 85%; text-align: left; vertical-align: top"> 
      ...
      <%--  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/FriendlyNames.aspx" CssClass="NodeStyle" Font-Names="Arial">FriendlyNames</asp:HyperLink>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          --%>      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; 
        <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Join%20Tables" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table border="0" cellpadding="1" cellspacing="0" width="100%" style="border-color: #808080">
     ...
     <tr>
       <td align="center" valign="top">
         ...
         <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="22px" Font-Names="Arial" >Database Joins:</asp:Label>
           <br /> <br />
        ...
        <tr>
            <td align="left" style="font-weight: bold; color: #ffffff; font-family: Arial; background-color: Gray; font-size:small;" class="auto-style1">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
                        <asp:DropDownList ID="DropDownListJoinOrigin" runat="server" Font-Size="Smaller" AutoPostBack="True">
                            <asp:ListItem Value="datadriven">datadriven</asp:ListItem>
                            <asp:ListItem Value="initial">initial</asp:ListItem>
                            <asp:ListItem Value="custom">custom</asp:ListItem>
                            <asp:ListItem Value="not used">not used</asp:ListItem>
                            <asp:ListItem Value="deleted">deleted</asp:ListItem>
                        </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblTablesCount" runat="server" Text=" " ForeColor="White"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:CheckBox ID="chkRedoJoins" runat="server" Text="delete existing joins" ForeColor="White" AutoPostBack="False" Checked="False" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp 
                       <asp:LinkButton ID="btnCalcJoins" runat="server" Text="Recalculate Joins" CssClass="NodeStyle" Visible="True" Enabled="True" Font-Names="Arial" ToolTip="It might take a long time"></asp:LinkButton>
                    </td>
        </tr>
        <tr>
            <td align="center" width="80%" >
        <table runat="server" id="list"  border=1 style="border-color: #808080; font-size: 12px; font-family: Arial">
                <tr>
                    <td class="auto-style3"  style="font-weight:bold">Table1</td>
                    <td class="auto-style3"  style="font-weight:bold">Field1</td> 
                    <td class="auto-style3"  style="font-weight:bold">Table2</td>                    
                    <td class="auto-style3"  style="font-weight:bold">Field2</td> 
                    <td class="auto-style2" style="font-weight:bold">Comments</td>
                    <td class="auto-style1" style="font-weight:bold">Delete</td>
                    <td class="auto-style1" style="font-weight:bold">&nbsp;&nbsp;Data/Report&nbsp;&nbsp;</td>
                    <td class="auto-style1" style="font-weight:bold">&nbsp;&nbsp;Analytics&nbsp;&nbsp;</td>
                    <td class="auto-style1" style="font-weight:bold">&nbsp;&nbsp;Correlations&nbsp;&nbsp;</td>
                </tr>           
        </table> 
        ...
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpJoinsList">
                <ProgressTemplate >
                <div class="modal">
                    <div class="center">
