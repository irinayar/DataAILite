<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TimeSeries.aspx.vb" Inherits="TimeSeries" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .modal { position:fixed; z-index:2147483647; height:100%; width:100%; top:0; background-color:#f8f8d3; opacity:.8; }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpTimeSeries" runat="server">
            <ContentTemplate>
                <table>
                    <tr><td colspan="3" style="font-size:x-large; font-weight:bold; background-color:#e5e5e5; vertical-align:middle; text-align:left; height:40px;"><asp:Label ID="LabelPageTtl" runat="server" Text="Online User Reporting"></asp:Label></td></tr>
                    <tr>
          ...
          <Nodes>
                        ...
                        <td style="width:85%; text-align:left; vertical-align:top;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkTimeBasedSummaries" runat="server" NavigateUrl="~/TimeBasedSummaries.aspx" CssClass="NodeStyle" Font-Names="Arial">Time Based Summaries</asp:HyperLink>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Time%20Series" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                            ...
                            <br /><br />
                            <div style="text-align:center;"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Time Series</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Calculate moving averages and rolling totals for time-series style report data."></asp:Label></div>
                            <br /><br />
                            <table class="controlpanel" cellpadding="4" cellspacing="0">
                                ...
                                <tr>
                                    <td style="font-weight:bold;">Number of time periods:</td><td><asp:TextBox ID="txtWindow" runat="server" Width="80px" Text="3"></asp:TextBox></td>
                                    <td style="font-weight:bold;">Date aggregation:</td><td><asp:DropDownList ID="DropDownDateRollup" runat="server"><asp:ListItem>Day</asp:ListItem><asp:ListItem>Month</asp:ListItem><asp:ListItem>Quarter</asp:ListItem><asp:ListItem>Year</asp:ListItem></asp:DropDownList></td>
                                </tr>
                                <tr><td colspan="4" style="font-weight:bold;">Search: <asp:TextBox ID="txtSearch" runat="server" Width="260px"></asp:TextBox><asp:Button ID="ButtonBuild" runat="server" CssClass="ticketbutton" Text="Build" /><asp:Button ID="ButtonReset" runat="server" CssClass="ticketbutton" Text="Reset" />&nbsp;&nbsp;<asp:Button ID="ButtonExportCSV" runat="server" CssClass="ticketbutton" Text="CSV" /><asp:Button ID="ButtonExportExcel" runat="server" CssClass="ticketbutton" Text="Excel" /><asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkTimeSeriesAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret the current time series results, moving averages, rolling totals, and notable periods.">AI</asp:LinkButton></td></tr>
                            </table>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers><asp:PostBackTrigger ControlID="ButtonExportCSV" /><asp:PostBackTrigger ControlID="ButtonExportExcel" /><asp:PostBackTrigger ControlID="lnkTimeSeriesAI" /></Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpTimeSeries"><ProgressTemplate><div class="modal"><div class="center"><asp:Image ID="imgProgress" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Controls/Images/WaitImage2.gif" />Please Wait...</div></div></ProgressTemplate></asp:UpdateProgress>
