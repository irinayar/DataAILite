<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarketSegments.aspx.vb" Inherits="MarketSegments" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Market Segmentation Model</title>
    <style type="text/css">
...
<br /><br />
<div class="marketTitleBlock"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial" ToolTip="Build market and business model analysis using the selected report fields.">Market Segmentation Model</asp:Label><asp:Label ID="LabelMarketSubtitle" runat="server" CssClass="marketSubtitle" ToolTip="This text explains the market model used by this page." Text="Shows customer, product, or market segments. Primary Field can combine multiple fields; Value Field is summed and averaged by the combined group, and Secondary Field can support grouped segment calculations."></asp:Label></div>
<br />
