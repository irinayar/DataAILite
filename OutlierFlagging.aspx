...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpOutlier" runat="server">
            <ContentTemplate>
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width:85%; text-align:left; vertical-align:top;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Outlier%20Flagging" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
            ...
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Flag outliers using standard deviation, percentage difference, or configurable business-rule thresholds."></asp:Label></div>
                            ...
                            <table class="controlpanel" cellpadding="4" cellspacing="0">
                                ...
                                <tr>
                                    <td style="font-weight:bold;">Std dev threshold:</td><td><asp:TextBox ID="txtStdDev" runat="server" Width="80px" Text="2"></asp:TextBox></td>
                                    <td style="font-weight:bold;">Percent threshold:</td><td><asp:TextBox ID="txtPercent" runat="server" Width="80px" Text="25"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td style="font-weight:bold;">Business min:</td><td><asp:TextBox ID="txtMin" runat="server" Width="80px"></asp:TextBox></td>
                                    <td style="font-weight:bold;">Business max:</td><td><asp:TextBox ID="txtMax" runat="server" Width="80px"></asp:TextBox></td>
                                </tr>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers><asp:PostBackTrigger ControlID="ButtonExportCSV" /><asp:PostBackTrigger ControlID="ButtonExportExcel" /><asp:PostBackTrigger ControlID="lnkOutlierAI" /></Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpOutlier">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
