<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ComparisonReports.aspx.vb" Inherits="ComparisonReports" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Comparison Reports</title>
    <style type="text/css">
        .NodeStyle {
            color: #0066FF;
            font-size: 12px;
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpComparison" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="main" style="width: 85%; text-align: left; vertical-align: top;">
                            <div style="text-align: left; width: 100%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Comparison%20Reports" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div style="text-align: center;">
                                    <asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Comparison Reports</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Compare two periods, groups, locations, SQL queries, or imported files using matched dimensions and values."></asp:Label>
                                </div>
                                <br /><br />

                                <table class="controlpanel" cellpadding="4" cellspacing="0">
                                    <tr>
                                        <td align="left" style="font-weight: bold;">Comparison:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownComparisonType" runat="server" AutoPostBack="True">
                                                <asp:ListItem Value="Periods">Two Periods</asp:ListItem>
                                                <asp:ListItem Value="Groups">Two Groups</asp:ListItem>
                                                <asp:ListItem Value="Locations">Two Locations</asp:ListItem>
                                                <asp:ListItem Value="Queries">Two Queries</asp:ListItem>
                                                <asp:ListItem Value="ImportedFiles">Two Imported Files</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" style="font-weight: bold;">Row field:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownRowField" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr id="trStandardCompare" runat="server">
                                        <td align="left" style="font-weight: bold;">Compare field:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownCompareField" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </td>
                                        <td align="left" style="font-weight: bold;">Base / compare:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownBaseValue" runat="server"></asp:DropDownList>
                                            <asp:DropDownList ID="DropDownCompareValue" runat="server"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr id="trQueryCompare" runat="server">
                                        <td align="left" style="font-weight: bold; vertical-align: top;">Base SQL query:</td>
                                        <td align="left" colspan="3">
                                            <asp:TextBox ID="txtBaseQuery" runat="server" TextMode="MultiLine" Rows="4" Width="720px" Font-Names="Consolas"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="trQueryCompare2" runat="server">
                                        <td align="left" style="font-weight: bold; vertical-align: top;">Compare SQL query:</td>
                                        <td align="left" colspan="3">
                                            <asp:TextBox ID="txtCompareQuery" runat="server" TextMode="MultiLine" Rows="4" Width="720px" Font-Names="Consolas"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr id="trFileCompare" runat="server">
                                        <td align="left" style="font-weight: bold;">Base file:</td>
                                        <td align="left">
                                            <asp:FileUpload ID="FileUploadBase" runat="server" Width="260px" />
                                        </td>
                                        <td align="left" style="font-weight: bold;">Compare file:</td>
                                        <td align="left">
                                            <asp:FileUpload ID="FileUploadCompare" runat="server" Width="260px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left" style="font-weight: bold;">Aggregation:</td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td align="left" colspan="4" style="font-weight: bold;">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkComparisonAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret this comparison report.">AI</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div style="font-family:Arial; font-size:small; padding-bottom:6px;"><asp:LinkButton ID="LinkButtonPrevious" runat="server" Font-Size="Small" OnClick="LinkButtonPrevious_Click">Previous</asp:LinkButton>&nbsp;&nbsp;<asp:Label ID="LabelPageNumberCaption" runat="server" Font-Names="Arial" Font-Size="Small" Text="Page Number"></asp:Label><asp:TextBox ID="TextBoxPageNumber" runat="server" Width="35px" Font-Names="Arial" Font-Size="Small" AutoPostBack="True" OnTextChanged="TextBoxPageNumber_TextChanged"></asp:TextBox><asp:Label ID="LabelPageCount" runat="server" Font-Names="Arial" Font-Size="Small"></asp:Label>&nbsp;&nbsp;<asp:LinkButton ID="LinkButtonNext" runat="server" Font-Size="Small" OnClick="LinkButtonNext_Click">Next</asp:LinkButton></div><div style="overflow: auto; max-width: 100%;">
                                    <asp:GridView ID="GridViewComparison" runat="server" CssClass="comparisongrid" AutoGenerateColumns="True" GridLines="Both"></asp:GridView>
                                </div>
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="ButtonBuild" />
                <asp:PostBackTrigger ControlID="ButtonExportCSV" />
                <asp:PostBackTrigger ControlID="ButtonExportExcel" />
                <asp:PostBackTrigger ControlID="lnkComparisonAI" />
            </Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpComparison">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
