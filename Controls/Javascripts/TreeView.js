...
function TreeView()
{
    this.treeView = {
        ...
        Type                : 'TREEVIEW',
        PathSeparator       : '\\',
        UpdateImageURL      : '../Images/TreeView/updating.gif',
	    ...
	    GetNodeCount : function(allSubtrees) {
...
TreeView.ParseJSON = function(json, treeView){
    ...
    if (json.LineStyle != void 0 && typeof (json.LineStyle) == 'string' && json.LineStyle.length > 0)
        treeView.LineStyle(json.LineStyle.toLowerCase());
...
function TreeNode(text, value, navigationURL, target, collapsedImageURL, expandedImageURL)
{
    this.treeNode = {
        ...
        _onNodeDragOver : function(evt) {
            ...
            if (trgt.treeNode.ConditionData == null)
        ...
        _onNodeDragStart : function(evt) {
            ...
            if (trgt.treeNode.ConditionData != null) {
                ...
                e.dataTransfer.setData("text", trgt.innerText);
            }
            else
                e.dataTransfer.effectAllowed = "none";
        },
        _onNodeDrop : function(evt) {
            var e = evt || window.event;
            var trgt = e.target || e.srcElement;
            ...
            if (dragSrcElement != null && trgt != dragSrcElement) {
                var targTreeNode = trgt.treeNode;
                var srcTreeNode = dragSrcElement.treeNode;
                var tv = targTreeNode.TreeView()
                if (targTreeNode.ConditionData != null && srcTreeNode.ConditionData != null) {
                    if (tv.NodeDropped) {
                        tv.NodeDropped(e, dragSrcElement, trgt);
                    }
        ...
        _init : function(){           
            ...
            _li.childNodes[0].innerHTML = '<img class="vertical_line" src="Controls/Images/TreeView/whitespace.png" ' + _hiddenElementStyle + '/><div class="hitarea" />';

            var _hitarea            = _li.childNodes[0].childNodes[1];

            if(_hitarea.addEventListener)
                _hitarea.addEventListener('click',this._onToggleClick, false);
            else if(_hitarea.attachEvent)
                _hitarea.attachEvent('onclick',this._onToggleClick);

            _hitarea.treeNode = this;
            
            var _hiddenElement = '<img class="border" src="Controls/Images/TreeView/whitespace.png" ' + _hiddenElementStyle + '/>';
            
            _li.childNodes[1].innerHTML = '<img class="indent" src="Controls/Images/TreeView/whitespace.png" ' + _hiddenElementStyle + '>';
            ...
            if (this.Draggable)
                _data.setAttribute("draggable", "true");
            if(_data.addEventListener){
                ...
                if (this.Draggable) {
                    _data.addEventListener('dragstart', this._onNodeDragStart, false);
                    _data.addEventListener('dragover', this._onNodeDragOver, false);
                    _data.addEventListener('drop', this._onNodeDrop, false);
                }
            }
                ...
                if (this.Draggable) {
                    _data.attachEvent('ondragstart', this._onNodeDragStart);
                    _data.attachEvent('ondragover', this._onNodeDragOver);
                    _data.attachEvent('ondrop', this._onNodeDrop);
                }
            };
        ...
        Collapse : function(ignoreChildren)  {
            var recursive = ignoreChildren ? false : true;
        ...
        PrevNode: function() {
            ...
            //if (node != null) {
                ...
                if (treeNodeCollection) {
                    if (index > 0) {
                        return treeNodeCollection[index - 1];
                    }
                    else if (index == 0 && node.Parent != void 0) {
                        return node.Parent;
                    };
                };
            //}
                ...
                if (index > -1 && node != void 0) {
                    ...
                    if (treeNodeCollection != void 0 && treeNodeCollection.length > 0) {
                        if (treeNodeCollection.length - 1 > index)
                            ...
                            return __gotoNextNode(node.Parent);
                    };
                };
            };
        ...
        NodeCount: function (allSubtrees) {
            if (this.ChildNodes.length > 0) {
                ...
                if (!allSubtrees)
                    ...
                    var ni = 0
                    for (ni = 0; ni <= this.ChildNodes.length - 1; ni++) {
                        var _node = this.ChildNodes[ni];
                        n = n + _node.NodeCount(allSubtrees);
                    }
                    return n;
                }
            }
        ...
        SetDraggable : function(value) {
            if (this._control && this._control._data != void 0) {
                if (value != void 0) {
                    if (this.Draggable == true && value == false) {
                        if (this._control._data.removeEventListener) {
                            this._control._data.removeEventListener('dragstart', this._onNodeDragStart);
                            this._control._data.removeEventListener('dragover', this._onNodeDragOver);
                            this._control._data.removeEventListener('drop', this._onNodeDrop);
                        }
                        else if (this._control._data.detachEvent) {
                            this._control._data.detachEvent('ondragstart', this._onNodeDragStart);
                            this._control._data.detachEvent('ondragover', this._onNodeDragOver);
                            this._control._data.detachEvent('ondrop', this._onNodeDrop);
                        };
                    }
                    else if (this.Draggable == false && value == true) {
                        if (this._control._data.addEventListener) {
                            this._control._data.addEventListener('dragstart', this._onNodeDragStart, false);
                            this._control._data.addEventListener('dragover', this._onNodeDragOver, false);
                            this._control._data.addEventListener('drop', this._onNodeDrop, false);
                        }
                        else if (this._control._data.attachEvent) {
                            this._control._data.attachEvent('ondragstart', this._onNodeDragStart);
                            this._control._data.attachEvent('ondragover', this._onNodeDragOver);
                            this._control._data.attachEvent('ondrop', this._onNodeDrop);
                        };
                    }
        ...
        SetTextColor : function(value) {
            if(this._control && this._control._data  != void 0){
                if(value != void 0 && value.length > 0) {
                    if (this._control._data.style.setAttribute) {
                        this._control._data.style.setAttribute("color",value);
                    }
                    else this._control._data.style.color = value;

                    this.TextColor = value;
                }
                return this._control._data.style.getAttribute ? this._control._data.style.getAttribute("color") : this._control._data.style.color;
            }
        ...
        SetConditionData: function (value) {
            if (value != void 0) {
        ...
        ToJSON : function(){
            var __treeNode = {
                ...
                Tag                   : this.Tag || "",
                ChildNodes            : null,
                ConditionData         : this.ConditionData || null
            };
        ...
        ToXML : function(){
            ...
            var __treeNode = '<TreeNode ';
                ...
                __treeNode += 'TextColor = "' + (this.TextColor || '') + '" ';
        ...
        Copy: function () {
            var nodeJSON = this.ToJSON();
            return TreeNode.ParseJSON(nodeJSON);
        }
    };
...
TreeNode.ParseJSON = function(json, treeNode){        
    if(json.Text != void 0){
        ...
        if (json.TextColor != void 0 && typeof (json.TextColor) == 'string' && json.TextColor.length > 0)
            treeNode.SetTextColor(json.TextColor);

        if (json.Tag != void 0 && typeof (json.Tag) == 'string' && json.Tag.length > 0)
            treeNode.SetTag(json.Tag);
        
        if (json.ConditionData != void 0)
            treeNode.SetConditionData(json.ConditionData);
...
TreeNode.ParseXML = function(xmlData, treeNode){           
    ...
    if(nodeElement != void 0 && nodeElement.nodeType === 1 && nodeElement.tagName == 'TreeNode'){
        ...
        var textColor           = nodeElement.getAttribute('TextColor');
        ...
        var tag = nodeElement.getAttribute('Tag');

        if(text != void 0 && typeof(text) == 'string' && text.length > 0) 
            treeNode.SetText(text);

        if (textColor != void 0 && typeof (textColor) == 'string' && textColor.length > 0)
            treeNode.SetTextColor(textColor);
        ...
        if (tag != void 0 && typeof (tag) == 'string' && tag.length > 0)
            treeNode.SetTag(tag);
