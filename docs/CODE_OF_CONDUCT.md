...
- Remove or edit content that violates this policy  
- Reject contributions that do not align with community standards  
- Temporarily or permanently ban contributors for repeated violations  
...
📧 Contact: https://oureports.net/OUReports/ContactUs.aspx
...
Maintainers may take the following actions depending on severity:
...
This project is built on collaboration and mutual respect.
