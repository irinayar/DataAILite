<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TimeBasedSummaries.aspx.vb" Inherits="TimeBasedSummaries" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Time Based Summaries</title>
    <style type="text/css">
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpSummary" runat="server">
            <ContentTemplate>
                <table>
            ...
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Summarize report values by day, week, month, quarter, or year when date fields are available."></asp:Label></div>
                            ...
                            <table class="controlpanel" cellpadding="4" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;">Aggregation:</td><td><asp:DropDownList ID="DropDownAggregate" runat="server"><asp:ListItem>Count</asp:ListItem><asp:ListItem>Sum</asp:ListItem><asp:ListItem>Avg</asp:ListItem><asp:ListItem>Min</asp:ListItem><asp:ListItem>Max</asp:ListItem></asp:DropDownList></td>
                                </tr>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers><asp:PostBackTrigger ControlID="ButtonExportCSV" /><asp:PostBackTrigger ControlID="ButtonExportExcel" /><asp:PostBackTrigger ControlID="lnkTimeBasedSummariesAI" /></Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpSummary"><ProgressTemplate><div class="modal"><div class="center"><asp:Image ID="imgProgress" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Controls/Images/WaitImage2.gif" />Please Wait...</div></div></ProgressTemplate></asp:UpdateProgress>
