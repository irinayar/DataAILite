<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Variance.aspx.vb" Inherits="Variance" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpVariance" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="main" style="width: 85%; text-align: left; vertical-align: top;">
                            <div style="text-align: left; width: 100%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Variance%20Analysis" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div style="text-align: center;">
                                    <asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Variance Analysis</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Compare base and comparison values to show percent change, variance, and contribution to total."></asp:Label>
                                </div>
                                <br /><br />

                                <table class="controlpanel" cellpadding="4" cellspacing="0">
                                    <tr>
                                        <td align="left" style="font-weight: bold;">Analysis:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownAnalysisType" runat="server" AutoPostBack="True">
                                                <asp:ListItem Value="Variance">Variance</asp:ListItem>
                                                <asp:ListItem Value="PercentageChange">Percentage Change</asp:ListItem>
                                                <asp:ListItem Value="Contribution">Contribution to Total</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" style="font-weight: bold;">Group field:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownGroupField" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left" colspan="4" style="font-weight: bold;">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkVarianceAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret this analysis.">AI</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div style="font-family:Arial; font-size:small; padding-bottom:6px;"><asp:LinkButton ID="LinkButtonPrevious" runat="server" Font-Size="Small" OnClick="LinkButtonPrevious_Click">Previous</asp:LinkButton>&nbsp;&nbsp;<asp:Label ID="LabelPageNumberCaption" runat="server" Font-Names="Arial" Font-Size="Small" Text="Page Number"></asp:Label><asp:TextBox ID="TextBoxPageNumber" runat="server" Width="35px" Font-Names="Arial" Font-Size="Small" AutoPostBack="True" OnTextChanged="TextBoxPageNumber_TextChanged"></asp:TextBox><asp:Label ID="LabelPageCount" runat="server" Font-Names="Arial" Font-Size="Small"></asp:Label>&nbsp;&nbsp;<asp:LinkButton ID="LinkButtonNext" runat="server" Font-Size="Small" OnClick="LinkButtonNext_Click">Next</asp:LinkButton></div><div style="overflow: auto; max-width: 100%;">
                                    <asp:GridView ID="GridViewAnalysis" runat="server" CssClass="analysisgrid" AutoGenerateColumns="True" GridLines="Both"></asp:GridView>
                                </div>
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="lnkVarianceAI" />
            </Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpVariance">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
