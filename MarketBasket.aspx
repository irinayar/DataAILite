<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarketBasket.aspx.vb" Inherits="MarketBasket" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Market Basket Model</title>
    <style type="text/css">
...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Market%20Basket" Target="_blank" CssClass="NodeStyle" Font-Names="Arial" ToolTip="Open help for market pages.">Help</asp:HyperLink>
...
<br /><br />
<div class="marketTitleBlock"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial" ToolTip="Build market and business model analysis using the selected report fields.">Market Basket Model</asp:Label><asp:Label ID="LabelMarketSubtitle" runat="server" CssClass="marketSubtitle" ToolTip="This text explains the market model used by this page." Text="Shows market-basket co-occurrence. Primary Field is the item, Secondary Field is the order, transaction, or invoice ID, and Value Field is summed as weighted basket value for matching item pairs."></asp:Label></div>
<br />
<table class="controlpanel" cellpadding="4" cellspacing="0">
<tr><td class="fieldLabel" title="Select one or more category, product, customer, location, or other fields used to group the market model.">Primary field(s):</td><td class="fieldControl"><asp:Panel ID="pnlPrimarySingle" runat="server"><asp:DropDownList ID="DropDownDimension" runat="server" ToolTip="Product, item, category, or description field used as the basket item."></asp:DropDownList></asp:Panel><asp:Panel ID="pnlPrimaryMulti" runat="server" Visible="False"><asp:ListBox ID="ListBoxDimension" runat="server" SelectionMode="Multiple" Rows="4" Width="210px" ToolTip="Select one or more fields to combine as the primary market grouping."></asp:ListBox></asp:Panel></td><td class="fieldLabel" title="Select the numeric field summed for matching basket pairs.">Value field:</td><td class="fieldControl"><asp:DropDownList ID="DropDownValueField" runat="server" ToolTip="Numeric value, sales, revenue, quantity, or amount summed as weighted basket value for matching item pairs."></asp:DropDownList></td></tr>
