<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarketDemand.aspx.vb" Inherits="MarketDemand" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Market Demand Model</title>
    <style type="text/css">
...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Market%20Demand" Target="_blank" CssClass="NodeStyle" Font-Names="Arial" ToolTip="Open help for market pages.">Help</asp:HyperLink>
...
<br /><br />
<div class="marketTitleBlock"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial" ToolTip="Build market and business model analysis using the selected report fields.">Market Demand Model</asp:Label><asp:Label ID="LabelMarketSubtitle" runat="server" CssClass="marketSubtitle" ToolTip="This text explains the market model used by this page." Text="Shows demand by selected market dimension. Primary Field can combine multiple fields; Value Field is summed as the demand measure, with record share and projected demand from the assumption percentage. When Date Field is selected, Date Aggregation groups demand by day, week, month, quarter, or year."></asp:Label></div>
<br />
