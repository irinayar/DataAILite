<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Profiling.aspx.vb" Inherits="Profiling" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpProfiling" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="main" style="width: 85%; text-align: left; vertical-align: top;">
                            <div style="text-align: left; width: 100%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Data%20Profiling" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <table class="controlpanel" cellpadding="4" cellspacing="0">
                                    <tr>
                                        <td align="left" style="font-weight: bold; white-space: nowrap;">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkProfilingAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret the data profile.">AI</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="lnkProfilingAI" />
            </Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpProfiling">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
