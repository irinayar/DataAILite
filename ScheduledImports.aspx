<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ScheduledImports.aspx.vb" Inherits="ScheduledImports" %>
        ...
        <table id="tblLinks" runat="server" border="0" width="100%">
            <tr>
                <td align="left" width="15%">
                    <a href="ScheduledImports.aspx">Refresh</a>
                </td>
                <td align="left" width="15%">
                    <a href="ScheduledImportsCalendar.aspx">Schedule Import</a>
                </td>
                <td width="10%"> <strong>  <asp:Label ID="Label1" runat="server" Text=""></asp:Label>  </strong></td>
                <td align="left" width="15%">
                    <a href="RunScheduledImports.aspx">Run Scheduled Imports</a>
                </td>
                <td width="40%">
                    &nbsp;&nbsp;&nbsp;&nbsp
                     <asp:HyperLink ID="HyperLinkPrev" runat="server" NavigateUrl="~/ScheduledImports.aspx?mnth=prev" BackColor="#99CCFF"><-previous</asp:HyperLink>
                    &nbsp;&nbsp                 
                    
                    <strong><strong><asp:Label ID="Label3" runat="server" Text="" Width="250px">Scheduled Imports</asp:Label> </strong></strong>
                     &nbsp;&nbsp                     
                     <asp:HyperLink ID="HyperLinkNext" runat="server" NavigateUrl="~/ScheduledImports.aspx?mnth=next" BackColor="#99CCFF">next-></asp:HyperLink>
                     &nbsp;&nbsp;&nbsp;&nbsp
