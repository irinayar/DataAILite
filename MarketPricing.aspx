<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MarketPricing.aspx.vb" Inherits="MarketPricing" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Market Pricing Model</title>
    <style type="text/css">
...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Market%20Pricing" Target="_blank" CssClass="NodeStyle" Font-Names="Arial" ToolTip="Open help for market pages.">Help</asp:HyperLink>
...
<br /><br />
<div class="marketTitleBlock"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial" ToolTip="Build market and business model analysis using the selected report fields.">Market Pricing Model</asp:Label><asp:Label ID="LabelMarketSubtitle" runat="server" CssClass="marketSubtitle" ToolTip="This text explains the market model used by this page." Text="Shows pricing sensitivity by price band. Primary field is optional: choose (None) to group by price band only, or choose a field to group by Dimension plus Price Band. Value Field is used as the price field, and Secondary Field is used as quantity or units."></asp:Label></div>
<br />
<table class="controlpanel" cellpadding="4" cellspacing="0">
<tr><td class="fieldLabel" title="Optionally select a category, product, customer, location, or other field to group pricing by Dimension plus Price Band. Select (None) for price-band-only analysis.">Primary field(s):</td><td class="fieldControl"><asp:Panel ID="pnlPrimarySingle" runat="server"><asp:DropDownList ID="DropDownDimension" runat="server" ToolTip="Optional pricing dimension. Select (None) to group only by price band."></asp:DropDownList></asp:Panel><asp:Panel ID="pnlPrimaryMulti" runat="server" Visible="False"><asp:ListBox ID="ListBoxDimension" runat="server" SelectionMode="Multiple" Rows="4" Width="210px" ToolTip="Select one or more fields to combine as the primary market grouping."></asp:ListBox></asp:Panel></td><td class="fieldLabel" title="Select the numeric field used for value, sales, quantity, revenue, profit, price, or score calculations.">Value field:</td><td class="fieldControl"><asp:DropDownList ID="DropDownValueField" runat="server" ToolTip="Quantity, sales, revenue, or other demand value."></asp:DropDownList></td></tr>
