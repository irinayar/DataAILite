<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ListOfDashboards.aspx.vb" Inherits="ListOfDashboards" %>
...
<body>
    ...
    <asp:UpdatePanel ID="udpDashboardList" runat ="server" >
       <ContentTemplate>
            <div>
           <table>
      <tr>
...
<asp:TreeView ID="TreeView1"  runat="server" Width="100%" NodeIndent="10" Font-Names="Times New Roman"  EnableTheming="True" ImageSet="BulletedList">
          <Nodes>  
            ...
            <asp:TreeNode Text="&lt;b&gt;Documentation&lt;/b&gt;"  Value="https://OUReports.net/OUReports/OnlineUserReporting.pdf#page=6" Expanded="True" >
    ...
    <table border="0" cellpadding="1" cellspacing="0" width="100%">
     ...
     <tr>
       <td align="center" valign="top">
        ...
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpDashboardList">
                <ProgressTemplate >
                <div class="modal">
                    <div class="center">
