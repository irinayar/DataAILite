<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CorrelationThreshold.aspx.vb" Inherits="CorrelationThreshold" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Correlation Threshold</title>
    <style type="text/css">
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpCorrelationThreshold" runat="server">
            <ContentTemplate>
                <table>
          ...
          <Nodes>
                        ...
                        <td style="width:85%; text-align:left; vertical-align:top;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkCorrelation" runat="server" NavigateUrl="~/Correlation.aspx" CssClass="NodeStyle" Font-Names="Arial">Correlation</asp:HyperLink>
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Correlation%20Threshold" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                            ...
                            <br /><br />
                            <div style="text-align:center;"><asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Correlation Threshold</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Filter correlations by threshold and show specialized views for stronger relationships between numeric fields."></asp:Label></div>
                            <br /><br />
                            <table class="controlpanel" cellpadding="4" cellspacing="0">
                                <tr><td style="font-weight:bold;">Minimum absolute correlation:</td><td><asp:TextBox ID="txtThreshold" runat="server" Width="80px" Text="0.55"></asp:TextBox></td><td style="font-weight:bold;">View:</td><td><asp:DropDownList ID="DropDownView" runat="server"><asp:ListItem Value="Both">Positive and Negative</asp:ListItem><asp:ListItem Value="Positive">Positive Only</asp:ListItem><asp:ListItem Value="Negative">Negative Only</asp:ListItem></asp:DropDownList></td></tr>
                                <tr><td colspan="4" style="font-weight:bold;">Search: <asp:TextBox ID="txtSearch" runat="server" Width="260px"></asp:TextBox><asp:Button ID="ButtonBuild" runat="server" CssClass="ticketbutton" Text="Build" /><asp:Button ID="ButtonReset" runat="server" CssClass="ticketbutton" Text="Reset" />&nbsp;&nbsp;<asp:Button ID="ButtonExportCSV" runat="server" CssClass="ticketbutton" Text="CSV" /><asp:Button ID="ButtonExportExcel" runat="server" CssClass="ticketbutton" Text="Excel" /><asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkCorrelationAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret the current correlation threshold results, strongest relationships, and fields that should be reviewed.">AI</asp:LinkButton></td></tr>
                            </table>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers><asp:PostBackTrigger ControlID="ButtonExportCSV" /><asp:PostBackTrigger ControlID="ButtonExportExcel" /><asp:PostBackTrigger ControlID="lnkCorrelationAI" /></Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpCorrelationThreshold">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
