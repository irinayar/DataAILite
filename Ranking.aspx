...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpRanking" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id="main" style="width: 85%; text-align: left; vertical-align: top;">
                            <div style="text-align: left; width: 100%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Ranking%20Analysis" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div style="text-align: center;">
                                    <asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Ranking Analysis</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Rank categories, customers, products, departments, locations, or other dimensions by top, bottom, or average values."></asp:Label>
                                </div>
                                <br /><br />

                                <table class="controlpanel" cellpadding="4" cellspacing="0">
                                    <tr>
                                        <td align="left" style="font-weight: bold;">Rank field:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownRankField" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </td>
                                        <td align="left" style="font-weight: bold;">Within group:</td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td align="left" style="font-weight: bold;">Rank type:</td>
                                        <td align="left">
                                            <asp:DropDownList ID="DropDownRankType" runat="server">
                                        ...
                                        <td align="left" style="font-weight: bold;">Number:</td>
                                        <td align="left">
                                            <asp:TextBox ID="txtTopN" runat="server" Width="40px">10</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" colspan="4" style="font-weight: bold;">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkRankingAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret the ranking result.">AI</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div style="font-family:Arial; font-size:small; padding-bottom:6px;"><asp:LinkButton ID="LinkButtonPrevious" runat="server" Font-Size="Small" OnClick="LinkButtonPrevious_Click">Previous</asp:LinkButton>&nbsp;&nbsp;<asp:Label ID="LabelPageNumberCaption" runat="server" Font-Names="Arial" Font-Size="Small" Text="Page Number"></asp:Label><asp:TextBox ID="TextBoxPageNumber" runat="server" Width="35px" Font-Names="Arial" Font-Size="Small" AutoPostBack="True" OnTextChanged="TextBoxPageNumber_TextChanged"></asp:TextBox><asp:Label ID="LabelPageCount" runat="server" Font-Names="Arial" Font-Size="Small"></asp:Label>&nbsp;&nbsp;<asp:LinkButton ID="LinkButtonNext" runat="server" Font-Size="Small" OnClick="LinkButtonNext_Click">Next</asp:LinkButton></div><div style="overflow: auto; max-width: 100%;">
                                    <asp:GridView ID="GridViewRanking" runat="server" CssClass="rankinggrid" AutoGenerateColumns="True" GridLines="Both"></asp:GridView>
                                </div>
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="lnkRankingAI" />
            </Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpRanking">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
