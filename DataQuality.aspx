<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DataQuality.aspx.vb" Inherits="DataQuality" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpDataQuality" runat="server">
            <ContentTemplate>
                <table>
                    <tr>
          ...
          <Nodes>
                        ...
                        <td id="main" style="width: 85%; text-align: left; vertical-align: top;">
                            <div style="text-align: left; width: 100%;">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkDataStats" runat="server" NavigateUrl="~/ShowReport.aspx?srd=8" CssClass="NodeStyle" Font-Names="Arial">Data and Statistics</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Data%20Quality" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div style="text-align: center;">
                                    <asp:Label ID="lblHeader" runat="server" Font-Size="22px" Font-Names="Arial">Data Quality</asp:Label>
            <asp:Label ID="LabelAnalysisSubtitle" runat="server" CssClass="analysisSubtitle" Text="Check data quality issues such as missing values, duplicates, invalid dates, out-of-range numbers, inconsistent categories, and suspicious text."></asp:Label>
                                </div>
                                <br /><br />

                                <table class="controlpanel" cellpadding="4" cellspacing="0">
                                    <tr>
                                        <td align="left" style="font-weight: bold;">Search records:</td>
                                        <td align="left">
                                            <asp:TextBox ID="txtSearch" runat="server" Width="260px"></asp:TextBox>
                                        </td>
                                        <td align="left" style="font-weight: bold;">Outlier stdev:</td>
                                        <td align="left">
                                            <asp:TextBox ID="txtStdDevLimit" runat="server" Width="40px">3</asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" colspan="4" style="font-weight: bold;">
                                            ...
                                            &nbsp;&nbsp;
                                            <asp:LinkButton OnClientClick="return showWaitingPanel();" ID="lnkDataQualityAI" runat="server" CssClass="aiLinkButton" Font-Names="Arial" ToolTip="Ask AI to interpret the data quality checks.">AI</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div style="font-family:Arial; font-size:small; padding-bottom:6px;"><asp:LinkButton ID="LinkButtonPrevious" runat="server" Font-Size="Small" OnClick="LinkButtonPrevious_Click">Previous</asp:LinkButton>&nbsp;&nbsp;<asp:Label ID="LabelPageNumberCaption" runat="server" Font-Names="Arial" Font-Size="Small" Text="Page Number"></asp:Label><asp:TextBox ID="TextBoxPageNumber" runat="server" Width="35px" Font-Names="Arial" Font-Size="Small" AutoPostBack="True" OnTextChanged="TextBoxPageNumber_TextChanged"></asp:TextBox><asp:Label ID="LabelPageCount" runat="server" Font-Names="Arial" Font-Size="Small"></asp:Label>&nbsp;&nbsp;<asp:LinkButton ID="LinkButtonNext" runat="server" Font-Size="Small" OnClick="LinkButtonNext_Click">Next</asp:LinkButton></div><div style="overflow: auto; max-width: 100%;">
                                    <asp:GridView ID="GridViewQuality" runat="server" CssClass="qualitygrid" AutoGenerateColumns="True" GridLines="Both"></asp:GridView>
                                </div>
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="lnkDataQualityAI" />
            </Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpDataQuality">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
