<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AuditSummaries.aspx.vb" Inherits="AuditSummaries" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="udpAudit" runat="server">
            <ContentTemplate>
                <table>
          ...
          <Nodes>
                        ...
                        <td style="width:85%; text-align:left; vertical-align:top;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLinkHelp" runat="server" NavigateUrl="DataAIHelp.aspx?hilt=Audit%20Summaries" Target="_blank" CssClass="NodeStyle" Font-Names="Arial">Help</asp:HyperLink>
...
<div class="analysisExplanation">
    ...
    <asp:Label ID="LabelOutputExplanation" runat="server"></asp:Label>
            ...
            <Triggers><asp:PostBackTrigger ControlID="ButtonExportCSV" /><asp:PostBackTrigger ControlID="ButtonExportExcel" /><asp:PostBackTrigger ControlID="lnkAuditAI" /></Triggers>
        </asp:UpdatePanel>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="udpAudit">
            <ProgressTemplate>
                <div class="modal">
                    <div class="center">
